    ...
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        isScrolled || isMobileMenuOpen
          ? 'bg-background/70 backdrop-blur-[24px] backdrop-saturate-150 border-b border-border/50 shadow-2xl'
          : 'bg-transparent backdrop-blur-none'
      }`}
      style={{
        WebkitBackdropFilter: isScrolled || isMobileMenuOpen ? 'blur(24px) saturate(150%)' : 'none',
      }}
    >
      ...
      {isMobileMenuOpen && (
        <div 
          className="md:hidden fixed left-0 right-0 top-16 bg-background/95 backdrop-blur-[24px] backdrop-saturate-150 border-t border-border/50 shadow-lg max-h-[calc(100vh-4rem)] overflow-y-auto"
